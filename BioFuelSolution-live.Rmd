...
print(paste("Fuel January:", sum(get.variables(model)[c(1:2,17:18)])))
print(paste("Fuel March:",sum(get.variables(model)[c(3,19)])))
print(paste("Fuel May:",sum(get.variables(model)[c(4,20)])))
print(paste("Fuel July:",sum(get.variables(model)[c(5:6,21:22)])))
print(paste("Fuel September:",sum(get.variables(model)[c(7,23)])))

print(required_corn)
print(paste("Corn January:",sum(get.variables(model)[c(8:9,24:25)])))
print(paste("Corn March:",sum(get.variables(model)[c(10:11,26:27)])))
print(paste("Corn May:",sum(get.variables(model)[c(12:13,28:29)])))
print(paste("Corn July:",sum(get.variables(model)[c(14:15,30:31)])))
print(paste("Corn September:",sum(get.variables(model)[c(16,32)])))
